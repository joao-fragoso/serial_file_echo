...
#
# sfe.tcl: Tcl script for re-creating project 'vivado_sfe'
#
# Generated by Vivado on Sun Nov 29 23:09:48 -03 2020
...
#
# 1. This project restoration tcl script (sfe.tcl) that was generated.
#
...
#
#    "/home/fragoso/XilinxLabs/serial_file_echo/srcs/counter.sv"
#    "/home/fragoso/XilinxLabs/serial_file_echo/srcs/file_handler.sv"
#    "/home/fragoso/XilinxLabs/serial_file_echo/srcs/serial_receiver.sv"
#    "/home/fragoso/XilinxLabs/serial_file_echo/srcs/serial_transmitter.sv"
#    "/home/fragoso/XilinxLabs/serial_file_echo/srcs/seven_segs.sv"
#    "/home/fragoso/XilinxLabs/serial_file_echo/srcs/serial_file_echo.sv"
#    "/home/fragoso/XilinxLabs/serial_file_echo/constraints/sef.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "vivado_sfe"
...
set orig_proj_dir "[file normalize "$origin_dir/vivado_sfe"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/srcs/file_handler.sv"] \
 [file normalize "${origin_dir}/srcs/serial_receiver.sv"] \
 [file normalize "${origin_dir}/srcs/serial_transmitter.sv"] \
 [file normalize "${origin_dir}/srcs/seven_segs.sv"] \
 [file normalize "${origin_dir}/srcs/serial_file_echo.sv"] \
]
...
set file "$origin_dir/srcs/file_handler.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/srcs/serial_receiver.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/srcs/serial_transmitter.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/srcs/seven_segs.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/srcs/serial_file_echo.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "sef" -objects $obj
...
set file "[file normalize "$origin_dir/constraints/sef.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/sef.xdc"
set file [file normalize $file]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a100tcsg324-2L -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a100tcsg324-2L -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
